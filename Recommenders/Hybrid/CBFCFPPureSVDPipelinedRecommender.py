...
class CBFCFPureSVDPipelinedRecommender(BaseRecommender):
    ...
    def __init__(
        ...
        self.recommender = PureSVDItemRecommender(
            recommender.URM_train.dot(recommender.W_sparse), verbose=verbose)
    ...
    def _compute_item_score(self, user_id_array, items_to_compute=None):
        self.recommender._compute_item_score(
            user_id_array=user_id_array, items_to_compute=items_to_compute)
