...
from src.Data_manager.DataReader_utils import download_from_URL, load_CSV_into_SparseBuilder
    ...
    def _load_from_original_file(self):
        ...
        try:
            ...
            dataFile = zipfile.ZipFile(
                zipFile_path + "hetrec2011-movielens-2k-v2.zip")
        ...
        URM_path = dataFile.extract(
            "user_ratedmovies.dat", path=zipFile_path + "decompressed/")
