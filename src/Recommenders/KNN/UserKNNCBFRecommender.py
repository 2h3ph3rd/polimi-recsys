...
from src.Recommenders.BaseCBFRecommender import BaseUserCBFRecommender
from src.Recommenders.BaseSimilarityMatrixRecommender import BaseUserSimilarityMatrixRecommender
...
class UserKNNCBFRecommender(BaseUserCBFRecommender, BaseUserSimilarityMatrixRecommender):
    ...
    def fit(self, topK=50, shrink=100, similarity='cosine', normalize=True, feature_weighting="none", **similarity_args):
        ...
        similarity = Compute_Similarity(self.UCM_train.T, shrink=shrink, topK=topK,
